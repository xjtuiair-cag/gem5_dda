...
#        'system.cpu.dcache.prefetcher.timely_accuracy_perPC::400c7c ',
#        'system.cpu.dcache.prefetcher.coveragePerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.dmp_pfIdentifiedPerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfBufferHitPerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfRemovedDemandPerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfTransFailedPerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfIssuedPerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfLatePerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfUsefulPerPC::400c7c ',
#        'system.cpu.dcache.prefetcher.pfUnusedPerPC::400c7c ',
...
#        'system.l2.prefetcher.timely_accuracy_perPC::400ca0 ',
#        'system.l2.prefetcher.coveragePerPC::400ca0 ',
#        'system.l2.prefetcher.dmp_pfIdentifiedPerPC::400ca0 ',
#        'system.l2.prefetcher.pfBufferHitPerPC::400ca0 ',
#        'system.l2.prefetcher.pfRemovedDemandPerPC::400ca0 ',
#        'system.l2.prefetcher.pfTransFailedPerPC::400ca0 ',
#        'system.l2.prefetcher.pfIssuedPerPC::400ca0 ',
#        'system.l2.prefetcher.pfLatePerPC::400ca0 ',
#        'system.l2.prefetcher.pfUsefulPerPC::400ca0 ',
#        'system.l2.prefetcher.pfUnusedPerPC::400ca0 ',
#        'system.l2.prefetcher.demandMshrMissesPerPC::400ca0 ',
#        'system.l2.prefetcher.pfLateRatePerPC::400ca0',
#        ]

stats_names = [
        'simSeconds',
        'system.l2.prefetcher.coverage_cosumed_perPC::400ca0',
        'system.l2.prefetcher.coverage_effective_perPC::400ca0',
        'system.l2.prefetcher.coverage_timely_perPC::400ca0',
        'system.l2.prefetcher.accuracy_cache_perPC::400ca0',
        'system.l2.prefetcher.accuracy_prefetcher_perPC::400ca0',
        'pfLateRatePerPC::400ca0',
        ]
